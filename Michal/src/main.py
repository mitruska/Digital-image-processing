...
#ex6.globalSingleThreshold(show=False, plot=False)
#ex6.globalMultiThreshold(bins=4, show=False, plot=False)
#ex6.localSingleThreshold(dim=21, show=False, plot=False)
#ex6.localMultiThreshold(dim=21, bins=4, show=False, plot=False)
